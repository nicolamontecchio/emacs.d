...
(el-get-bundle julia-repl)
(el-get-bundle julia-vterm)
...
;; ;; EXAMPLE: Locally defined recipe
;; (el-get-bundle yaicomplete
;;   :url "https://github.com/tarao/elisp.git"
;;   :features yaicomplete)
;; ;; EXAMPLE: Locally defined recipe with initialization code
;; (el-get-bundle zenburn-theme
;;   :url "https://raw.githubusercontent.com/bbatsov/zenburn-emacs/master/zenburn-theme.el"
;;   (load-theme 'zenburn t))

;; Call `el-get' to make sure all packages (and deps) are setup.
(el-get 'sync)
...
(custom-set-variables
 ...
 '(package-selected-packages '(flatland-theme el-get)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
